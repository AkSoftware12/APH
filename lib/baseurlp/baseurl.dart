...
var home = baseUrl + "get_posts";
var comment = baseUrl + "comment";
var PostDelete = baseUrl + "post_delete";
var BlockUser = baseUrl + "block_user";
var chatDelete = baseUrl + "chat_delete";
var UnblockUser = baseUrl + "unblock_user";
...
var lastChat = baseUrl + "all_chat_get_admin";
var addNotification = baseUrl + "add_notification";
...
var like= baseUrl + "like";
var chatUser = baseUrl + "chat_user";
var chatGetUser  = baseUrl + "chat_get_user";
