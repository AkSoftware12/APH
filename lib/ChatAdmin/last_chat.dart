...
class _NotificationScreenState extends State<LastChatScreen> {
  List<dynamic> apiData = [];
  Timer? timer;

  File? avatarImageFile;
  Future<void> lastChatApi() async {
    // Replace 'your_token_here' with your actual token

    final SharedPreferences prefs = await SharedPreferences.getInstance();
    final String? token =  prefs.getString('token',);
    final Uri uri = Uri.parse(lastChat);
  ...
  void initState() {
    super.initState();
    lastChatApi();
    timer = Timer.periodic(Duration(seconds: 5), (Timer t) =>        lastChatApi());
                            ...
                            child: Column(
                              children: [
                                ListTile(
                                    ...
                                    subtitle: Text(apiData[index]['chat'].toString()),
